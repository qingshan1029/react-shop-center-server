...
var departments =
  [
    new Department({
      departmentName: 'Leather',
      categories: 'Basics,Blazer'
    }),
    new Department({
      departmentName: 'Trousers',
      categories: 'Knitwear,Jeans,Jackets'
    }),
    new Department({
      departmentName: 'Shirt',
      categories: 'T-Shirt,Top-trend'
    }),
    new Department({
      departmentName: 'Suit',
      categories: 'Suit-1,Suit-2,Suit-3'
    })
  ]
...
var products =
  [
    ...
    new Product({
      ...
      imagePath: 'http://192.168.1.52/E:/KKJ_Work/0.ShoppingSite/ShoppingApp/Ecommerce-Nodejs-master/TestData/images/T-Shirt/1.jpg',
      title: 'New Type T-Shirt',
      description: 'High quality. lower price.',
      price: 55.559,
      color: 'Blue',
      size: 'XS,M,XL,XXL,X3L',
      quantity: 22,
      department: 'Shirt',
      category: 'T-Shirt',
    }),
    new Product({
      ...
      imagePath: 'http://192.168.1.52/E:/KKJ_Work/0.ShoppingSite/ShoppingApp/Ecommerce-Nodejs-master/TestData/images/Suit/1.jpg',
      title: '2019 year best suit',
      description: 'Best good suit. high price',
      price: 999.999,
      color: 'Olive',
      size: 'X4L,X3L,XXL,XS,M,XL',
      quantity: 26,
      department: 'Suit',
      category: 'Suit-1',
    })
...
var variants =
  [
    ...
    new Variant({
      ...
      imagePath: '/assets/images/product/T-Shirt/1.jpg',
      color: 'Olive',
      size: 'M,XL,XXL',
      quantity: 45,
    }),
    new Variant({
      productID: '5bedf5eec14d7822b39d9d4e',
    imagePath: 'http://192.168.1.52/E:/KKJ_Work/0.ShoppingSite/ShoppingApp/Ecommerce-Nodejs-master/TestData/images/Suit/3.jpg',
    color: 'Orange',
    size: 'M,XL,3XL',
    quantity: 23,
})
